/*
 * 
 * This code is only for better User Interface
 * and
 * to get a proper output rather than a console output.
 * It can also be implemented by a separate, dedicated HTML page 
 * taking input through Model Map from the Java code.
 * 
 */
